package it.unibo.DifferentialDriveSimulator.configuration;
...
/**
 * Implementation of the IConfiguration class used in a simulated environment, it allow the mock robot the 
